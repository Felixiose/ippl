...
int main(int argc, char* argv[]) {
    ippl::initialize(argc, argv);
    {
        ...
        for (unsigned int it = 0; it < nt; ++it) {
            ...
            //        dumpVTK(field, field.get_mesh().getGridsize(0),
            //        field.get_mesh().getGridsize(1),
            //                field.get_mesh().getGridsize(2), it,
            //                field.get_mesh().getMeshSpacing(0),
            //                field.get_mesh().getMeshSpacing(1),
            //                field.get_mesh().getMeshSpacing(2));
        }
